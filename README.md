...
This fork also publishes a Fedora package for Vesktop Flatpak, with the pinned
[VesktopClaudeBridge](https://github.com/x3cca/VesktopClaudeBridge) project
bundled as a Vencord userplugin and registered as a local Codex MCP server.
See [Fedora package instructions](packaging/README.md).
